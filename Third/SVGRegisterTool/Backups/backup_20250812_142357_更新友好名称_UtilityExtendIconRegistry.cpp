...
void FUtilityExtendIconRegistry::CreateUserCustomIconSet(TArray<FToolbarIconInfo>& IconInfos)
{
    // ============================================================================
    // 用户自定义区域
    IconInfos.Add(FToolbarIconInfo(TEXT("UtilityExtend.NEXIcon"), TEXT("NEX图标A"), TEXT("用户自定义图标")));
    IconInfos.Add(FToolbarIconInfo(TEXT("UtilityExtend.Inno"), TEXT("Inno图标"), TEXT("用户自定义图标")));
    // ============================================================================
    // 在这里继续添加代码
